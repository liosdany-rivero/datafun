...
// Verificar permisos para la caja principal (establecimiento 800)
$user_id = $_SESSION['user_id'];
$query = "SELECT permiso FROM permisos_establecimientos WHERE user_id = ? AND establecimiento_codigo = 800";
...
// Cargar los registros paginados (orden descendente)
$operaciones = [];
if ($total_registros > 0) {
    $query = "SELECT * FROM caja_principal ORDER BY numero_operacion DESC LIMIT $inicio, $por_pagina";
...
<div class="form-container">
    <h2>Operaciones de Caja Principal</h2>
