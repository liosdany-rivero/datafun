...
ob_start();
/**
 * ARCHIVO: caja_galletera_flujo.php
 * DESCRIPCIÓN: Visualización del flujo de caja de galletera
 * 
 * FUNCIONALIDADES:
 * - Visualización de listado completo del flujo de caja de galletera
...
// Verificar permisos para el centro de costo 708 (Caja galletera)
$tiene_permiso = false;
$puede_tramitar = $es_admin;

$sql_permisos = "SELECT permiso FROM permisos 
                WHERE user_id = ? AND centro_costo_codigo = 708 AND permiso IN ('leer', 'escribir', 'tramitar')";
...
if (!$tiene_permiso && !$es_admin) {
    echo "<div class='form-container'><p>No tiene permisos para visualizar la caja de galletera.</p></div>";
...
<div class="form-container">
    <h2>Caja Galletera - Flujo</h2>

    <!-- Formulario de filtrado -->
    <form id="filtrosForm" method="GET" action="caja_galletera_flujo.php" class="filtros-form" style="display: <?= (isset($_GET['tramitado']) || isset($_GET['fecha_inicio']) || isset($_GET['fecha_fin']) || isset($_GET['tipo'])) ? 'none' : 'block' ?>;">
