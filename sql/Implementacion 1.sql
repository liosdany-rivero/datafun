-- PRIMERA IMPLEMENTACION DE CODIGO SQL
...
-- 5. Insertando almacenes en USD en la base de datos
INSERT INTO
    centros_costo (
        codigo,
        nombre,
...
-- 6. Insertar registros en la tabla permisos
INSERT INTO
    permisos (
        user_id,
        centro_costo_codigo,
...
VALUES (1, 640, 'escribir'),
    (1, 700, 'escribir'),
    (10, 640, 'tramitar'),
    (10, 700, 'tramitar');

-- 7. Agregar campo almacen_id a la tabla almacen_canal_inventario_usd
...
-- 8. Agregar campo almacen_id a la tabla almacen_canal_tarjetas_estiba_usd
...
---- FIN DE LA PRIMERA IMPREMENTACION